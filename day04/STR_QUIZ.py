a = input("소문자로 입력하세요").upper()
print(a)
l ="""Memories follow me left and right
...
You take up every corner of my mind (what you gon' do now?)
""".count("left")
r = """ Memories follow me left and right
I can feel you over here, I can feel you over here
You take up every corner of my mind (what you gon' do now?)
Ever since the d-day y-you went away (no, I don't know how)
How to erase your body from out my brain (what you gon' do now?)
...
c = input("이메일 주소를 입력하세요")
k = c.split("@")
print(f"사용자 이름은: {k[0]}, 주소는 {k[1]}")

u = "Hello python".split(" ")
print(u[1])
